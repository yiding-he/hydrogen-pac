...
var configuration = {
    proxies: [{"host":"localhost","name":"禁止访问","port":0,"type":"PROXY"},{"host":"localhost","name":"GFW","port":7890,"type":"SOCKS5"},{"host":"localhost","name":"阿里云","port":2345,"type":"SOCKS5"},{"host":"localhost","name":"新华书店","port":2346,"type":"SOCKS5"},{"name":"直接访问","port":0,"type":"DIRECT"}],
    patternLists: [{"name":"黑名单","patterns":["baidu"],"proxyName":"禁止访问"},{"name":"GFW","patterns":["google","facebook","github"],"proxyName":"GFW"}]
};
